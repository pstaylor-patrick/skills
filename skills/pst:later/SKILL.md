...
argument-hint: ""
allowed-tools: Agent, Skill, TaskList
---
...
2. Invoke `/pst:now` and `/pst:next` in parallel (via two background Haiku agents or by calling the skills directly). Collect both outputs.
